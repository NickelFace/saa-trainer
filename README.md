...
- **Answer walkthroughs** — for covered questions the review explains why the key is
  ...
  968 of 1019 questions so far; the layer lives in `data/explanations.json` and grows
  chapter by chapter.
...
defects, 7 questions with exhibits. Written walkthroughs: 968 of 1019 questions — every
